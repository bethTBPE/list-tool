...
## Плани розвитку
- [x] Додати функції додавання та видалення елементу зі списка
- [x] Додати функцію пошуку елемента у списку
- [ ] Додати функцію підрахунку кількості елементів у списку
- [ ] Додати функцію сортування списку
- [ ] Додати функцію збереження та завантаження списку з файл
